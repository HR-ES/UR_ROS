...
#include "ur3e_ros_data/msg/detail/joint_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur3e_ros_data::msg::JointPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur3e_ros_data::msg::JointPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur3e_ros_data::msg::JointPose *>(
    untyped_ros_message);
...
{
  return &ur3e_ros_data::msg::typesupport_fastrtps_cpp::_JointPose__handle;
}
