...
bool ur3e_ros_data__msg__joint_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur3e_ros_data.msg._joint_pose.JointPose", full_classname_dest, 39) == 0);
  }
  ur3e_ros_data__msg__JointPose * ros_message = _ros_message;
  {  // joint1
...
PyObject * ur3e_ros_data__msg__joint_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ur3e_ros_data.msg._joint_pose");
