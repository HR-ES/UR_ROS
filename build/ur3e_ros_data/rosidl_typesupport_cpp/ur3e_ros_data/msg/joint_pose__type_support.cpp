...
static const _JointPose_type_support_symbol_names_t _JointPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur3e_ros_data, msg, JointPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur3e_ros_data, msg, JointPose)),
  }
};
...
{
  return &::ur3e_ros_data::msg::rosidl_typesupport_cpp::JointPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur3e_ros_data, msg, JointPose)() {
  return get_message_type_support_handle<ur3e_ros_data::msg::JointPose>();
}
