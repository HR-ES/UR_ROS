...
def generate_launch_description():
    ...
    ur3e_srdf_path = os.path.join(
        get_package_share_directory('ur3e_moveit'))
    # UR3 ROBOT urdf file path:
    srdf_file = os.path.join(ur3e_srdf_path,
                              'config',
                              'ur3e.srdf')
    print("Configuring moveit config")
    moveit_config = (MoveItConfigsBuilder("ur3e")
                     .robot_description(
                         ...
                         .robot_description_semantic(
                             ...
                             .trajectory_execution(file_path=moveit_simple_controllers_yaml)
                             .planning_pipelines(
    ...
    moveJ_interface = Node(name='moveJ_action',
                           ...
                           output='screen',
                           parameters=[moveit_config.robot_description, moveit_config.robot_description_semantic, moveit_config.robot_description_kinematics, {"use_sim_time": True}],)
