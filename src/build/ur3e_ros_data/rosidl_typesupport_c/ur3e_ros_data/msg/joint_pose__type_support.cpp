...
static const _JointPose_type_support_symbol_names_t _JointPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur3e_ros_data, msg, JointPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur3e_ros_data, msg, JointPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ur3e_ros_data, msg, JointPose)() {
  return &::ur3e_ros_data::msg::rosidl_typesupport_c::JointPose_message_type_support_handle;
}
