...
#include "ur3e_ros_data/msg/detail/joint_pose__rosidl_typesupport_fastrtps_c.h"
...
using _JointPose__ros_msg_type = ur3e_ros_data__msg__JointPose;
...
static uint32_t _JointPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur3e_ros_data__msg__JointPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur3e_ros_data__msg__JointPose;
    is_plain =
      (
...
static size_t _JointPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur3e_ros_data__msg__JointPose(
